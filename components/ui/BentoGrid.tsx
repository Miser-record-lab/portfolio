...
export const BentoGridItem = ({
  ...
  id?: number;
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('miseryh.pro@gmail.com');
        setCopied(true);
    }
  return (
    <div
    ...
    >
        <div className={`${id === 6 && 'flex justify-center'} h-full'`}>
            ...
            <div className={cn(
                ...
                <div className="font-sans font-bold text-lg lg:text-2xl max-w-96 z-50">
                    {title}
                </div>
            ...
            {id === 3 && (
                <div className="flex lg:mt-12 gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
                    <div className="flex flex-col gap-3 md:gap-3 lg:gap-4">
                        {['Bubble', 'Metabase', 'n8n'].map
                        ((item) => (
